...
public class InternationalFlight extends JFrame
{
	...
	public InternationalFlight(LoginPage type1)
	{
		...
		String[] sItem1={"Addis Ababa"};
		String[] sItem2={"Ethiopia","Bangkok","Cairo","CapeTown","Chicago","Dubai","Frankfurt","HongKong","Istanbul","London","LosAngeles","Melbourne","New York","Paris","Rome","SanFrancisco","shanghai","Singapore","Sydney","Toronto"};
